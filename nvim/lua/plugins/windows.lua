return {
  ...
  },
  {
    ...
    keys = {
      ...
      { "<C-Left>", "<Cmd>SmartCursorMoveLeft<CR>", mode = { "n", "t" } },
      { "<C-Down>", "<Cmd>SmartCursorMoveDown<CR>", mode = { "n", "t" } },
      { "<C-Up>", "<Cmd>SmartCursorMoveUp<CR>", mode = { "n", "t" } },
      { "<C-Right>", "<Cmd>SmartCursorMoveRight<CR>", mode = { "n", "t" } },
