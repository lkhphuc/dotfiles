return {
  ...
  },
  {
    ...
    keys = {
      ...
      { "<C-h>", "<Cmd>SmartCursorMoveLeft<CR>", mode = { "n", "t", "i" } },
      { "<C-j>", "<Cmd>SmartCursorMoveDown<CR>", mode = { "n", "t", "i" } },
      { "<C-k>", "<Cmd>SmartCursorMoveUp<CR>", mode = { "n", "t", "i" } },
      { "<C-l>", "<Cmd>SmartCursorMoveRight<CR>", mode = { "n", "t", "i" } },
      ...
      { "<C-Left>", "<Cmd>SmartCursorMoveLeft<CR>", mode = { "n", "t", "i" } },
      { "<C-Down>", "<Cmd>SmartCursorMoveDown<CR>", mode = { "n", "t", "i" } },
      { "<C-Up>", "<Cmd>SmartCursorMoveUp<CR>", mode = { "n", "t", "i" } },
      { "<C-Right>", "<Cmd>SmartCursorMoveRight<CR>", mode = { "n", "t", "i" } },
      { "<A-Left>", "<Cmd>SmartResizeLeft<CR>", mode = { "n", "t" } },
      { "<A-Down>", "<Cmd>SmartResizeDown<CR>", mode = { "n", "t" } },
      { "<A-Up>", "<Cmd>SmartResizeUp<CR>", mode = { "n", "t" } },
      { "<A-Right>", "<Cmd>SmartResizeRight<CR>", mode = { "n", "t" } },
  ...
  },
  {
    ...
    opts = {
      ...
      selection_chars = 'TNSERIAODHPLCFUWYX',
      filter_rules = {
        bo = { filetype = { "incline", "noice" }, buftype = {"nofile"} },
      },
    },
  },
  {
